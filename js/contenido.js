...
function generadorAutomatico() {
    ...
    canciones.push(new Contenido("Rap", "Sofia Gabanna", "Twister", meGusta(), "N5ioeY8RogA"))
    canciones.push(new Contenido("Rap", "Sofia Gabanna", "Vivimos deprisa", meGusta(), "-PkNgMNnr2I"))
    ...
    canciones.push(new Contenido("Rap", "Craneo", "Ahumado", meGusta(), "7JJBIja3ooI"))
